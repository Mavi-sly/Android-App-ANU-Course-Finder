 ...
 */
/**
 * The following interface defines required methods of any Tree.(no delete)
 *
...
public abstract class Tree<T extends Comparable<T>> {
    ...
    public String display(int tabs) {
        ...
        sb.append("\n").append("\t").append("├─").append(leftNode.display(tabs + 1));
        sb.append("\n").append("\t").append("├─").append(rightNode.display(tabs + 1));
        return sb.toString();
    }
